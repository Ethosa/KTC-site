<template>
  <main class="flex flex-row bg-slate-900 cursor-default overflow-hidden">
    <div class="flex">
      <div
        class="flex w-5/12 h-screen justify-center animate__animated animate__fadeInUp animate__delay-1s"
      >
      ...
      <div
        class="flex flex-col w-1/2 justify-center gap-20 text-white font-sans"
      >
        <div
          class="flex flex-col gap-10 animate__animated animate__fadeInRight"
        >
          ...
          <div>
            <div class="w-full flex gap-2 justify-center text-2xl">
              Доступно для
              <!-- todo: change link to nightly.link -->
              <a href="https://github.com/Ethosa/KTC/releases/latest"
                ><svg
                  class="fill-white transition-all hover:fill-slate-400"
        ...
        <!-- <div class="flex justify-end text-xl gap-3 items-center animate__animated animate__fadeInUp">
          <a href="https://github.com/Ethosa/KTC">
            <svg
              width="30px"
              height="40px"
              viewBox="0 0 24 24"
        ...
        <div
          class="flex justify-end text-xl gap-3 items-center animate__animated animate__fadeInUp animate__delay-3s"
        >
          <a href="https://github.com/Ethosa/KTC">
            <svg
              xmlns="http://www.w3.org/2000/svg"
