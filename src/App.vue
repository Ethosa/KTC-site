<template>
  <main class="flex flex-row bg-nightpurple-900 text-nightpurple-700 cursor-default overflow-hidden">
    <div class="flex">
      <div
          ...
          <div>
            <div class="w-full flex gap-2 justify-center text-2xl">
              ...
              <a href="https://github.com/Ethosa/KTC/releases/latest">
                <svg
                  class="transition-all fill-nightpurple-500 hover:fill-nightpurple-700 hover:scale-110"
